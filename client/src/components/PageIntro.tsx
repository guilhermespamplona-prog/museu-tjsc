...
export default function PageIntro({ eyebrow, title, description, backHref = "/", backLabel = "Memória TJSC" }: PageIntroProps) {
  return (
    <section className="px-5 py-10 md:px-8 md:py-14 lg:px-12 lg:py-16">
      ...
      <h1 className="mt-4 max-w-4xl text-balance font-display text-4xl font-normal leading-[1.08] tracking-[-0.03em] text-[#1f1e1c] md:text-6xl md:leading-[1.04] lg:text-[4.35rem]">
        {title}
      </h1>
